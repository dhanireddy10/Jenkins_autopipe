...
#
# tutorial1.tcl: Tcl script for re-creating project 'tutorial1'
#
# Generated by Vivado on Thu Nov 25 11:22:53 CET 2021
...
#
# 1. This project restoration tcl script (tutorial1.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/../tutorial1"]"
...
set files [list \
 [file normalize "$origin_dir/../tutorial1/blinky.v" ]\
]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *$origin_dir/../blinky.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *$origin_dir/../blinky.xdc]" -objects $obj
